  ...
  <div class='job-detail'>
    ...
    <div class='detail boxShadow'>
      <div class='top'>
        ...
        <p class='descripe'>
          <span class='prop'>{{job.price}}</span>
          <span class='prop unit' v-show='job.price'>元/月</span>
        </p>
        <el-button class='apply' size='small' @click='showMask'>投递意向</el-button>
      </div>
...
export default {
  ...
  created() {
    this.jobId = this.$route.params.serviceId;
    this.getJobDetail();
  },
  updated() {
